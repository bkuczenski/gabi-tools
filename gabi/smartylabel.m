function smartylabel(ax)
% function smartylabel
% Exact repeat of smartxlabel because cmon, this isn't python and what a pain in
% the ass.
...
set(ax,'ytick',xt,'yticklabel',xtickl)
